...
# # OmniVoice Filipino PLD full fine-tuning with best-eval checkpointing on Kaggle
...
# %% [code] {"jupyter":{"outputs_hidden":false}}
RUN_NAME = "full-filipino-pld-best-eval"
...
OUTPUT_DIR = WORK_DIR / "exp_full_best_eval"
RESULTS_DIR = WORK_DIR / "results" / "full_best_eval"
BASELINE_RESULTS_DIR = RESULTS_DIR / "base"
FINETUNED_RESULTS_DIR = RESULTS_DIR / "finetuned"
METRICS_DIR = WORK_DIR / "metrics" / "full_best_eval"
...
WANDB_MODE = "online"
WANDB_TAGS = ["omnivoice", "filipino", "pld", "kaggle", "full", "best-eval"]

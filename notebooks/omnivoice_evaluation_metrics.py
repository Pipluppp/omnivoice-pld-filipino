...
# # OmniVoice Filipino PLD full test-set evaluation on Kaggle
# This notebook-style script evaluates the base and fine-tuned OmniVoice models on
# the full PLD Filipino test split. It downloads the fine-tuned checkpoint from a
# W&B artifact, generates speech, computes OmniVoice objective metrics, and logs
# the evaluation outputs back to W&B.
...
# This notebook is the full evaluation run. Use the separate smoke notebook when
# validating setup changes before committing to the multi-hour full test-set run.

# %% [code] {"jupyter":{"outputs_hidden":false}}
RUN_NAME = "full-filipino-pld-test-eval"
...
WORK_DIR = Path("/kaggle/working/omnivoice_filipino_pld_eval")
TEMP_DIR = Path("/kaggle/temp/omnivoice_filipino_pld_eval")
MANIFEST_DIR = WORK_DIR / "manifests"
RESULTS_DIR = WORK_DIR / "results" / "full_test"
BASE_RESULTS_DIR = RESULTS_DIR / "base"
FINETUNED_RESULTS_DIR = RESULTS_DIR / "finetuned"
METRICS_DIR = WORK_DIR / "metrics" / "full_test"
...
WANDB_MODE = "online"
WANDB_TAGS = ["omnivoice", "filipino", "pld", "kaggle", "evaluation", "full-test"]
...
# Both models synthesize the same full-test manifest. The base model is loaded
...
def log_wandb_outputs() -> None:
    ...
    results_artifact = wandb.Artifact(
        "omnivoice-filipino-full-test-eval-results",
        type="evaluation",
        metadata={
            "run_name": RUN_NAME,

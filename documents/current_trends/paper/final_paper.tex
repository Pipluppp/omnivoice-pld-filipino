...
Figure~\ref{fig:pipeline} shows the system architecture across data preparation, tokenization, Kaggle fine-tuning, evaluation, and public delivery.

\begin{figure*}[t]
  \centering
  \small
  \resizebox{0.98\textwidth}{!}{\input{../../figures/system_architecture_tikz.tex}}
...
\label{app:ct-supplementary}

The full interactive experiment report is available in the project's W\&B workspace (footnote in Section 3.3). Figure~\ref{fig:ct-final-four-model-metrics} shows the final metric comparison across all three evaluation metrics, Figure~\ref{fig:ct-step-5000-lr-1e-5} shows the W\&B record of the recommended learning-rate 1e-5 run, and Figures~\ref{fig:ct-base-test-samples} and~\ref{fig:ct-finetune-5000-test-samples} show the W\&B generated-test-sample tables for the base model and the recommended fine-tuned checkpoint.
